...
# --- ตกแต่ง CSS หน้าเว็บขยายการ์ดรูปภาพแจกเต็มกรอบสวยงาม ---
st.markdown(
    """
    <style>
...
if view_mode == "🏠 หน้าแรกแกลเลอรี":
    ...
    with col_shelves_area:
        ...
        # --------------------------------------------------
        # 🌟 ชั้นวางปกติที่ 1: 🎨 ของแจกสำหรับแฟนๆ ทั้งหมด (ขยายรูปภาพเต็มกรอบสวยงาม)
        # --------------------------------------------------
...
# ==========================================
    ...
    if password_input == ADMIN_PASSWORD:
        st.success("🔓 ยืนยันตัวตนสำเร็จ! โหมดรูปแจกขยายขนาดเต็มเฟรมพร้อมรันระบบแล้วครับแนท")
        st.markdown("---")
