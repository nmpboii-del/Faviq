...
# --- ตกแต่ง CSS หน้าเว็บ บังคับขยายรูปแจกเต็มกรอบชัวร์ 100% ---
st.markdown(
    """
    <style>
    ...
    /* สไตล์การ์ดรูปแจกขยายเต็มพื้นที่อย่างสวยงาม ไม่เล็กจิ๋วแล้วครับ */
    ...
    .gift-img { width: 100% !important; height: 100% !important; object-fit: cover !important; border-radius: 10px; }
...
# ==========================================
    ...
    if password_input == ADMIN_PASSWORD:
        st.success("🔓 ยืนยันตัวตนสำเร็จ! โหมดแก้ไขและขยายขนาดสมบูรณ์พร้อมทำงานแล้วครับแนท")
        st.markdown("---")
        ...
        # 🎨 3. จัดการรูปภาพแจกฟรี (แก้ไขคำสั่งคีย์ตัวแปรที่ผิดพลาดเรียบร้อยแล้ว)
        with st.expander("🎨 3. จัดการรูปภาพแจกฟรีให้แฟนคลับ (แก้ไข/ปักหมุด/ลบ)"):
            ...
            with col_g1:
                ...
                with st.form(key="add_gift_exp_v8", clear_on_submit=False):
                    ...
                    gift_submit = st.form_submit_button(gift_btn_txt) # เคลียร์บั๊กตรงจุดนี้เรียบร้อยแล้วครับ ✨
